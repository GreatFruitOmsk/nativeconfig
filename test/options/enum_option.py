...
class TestEnumOption(TestOptionMixin, unittest.TestCase):
    ...
    def setUpClass(cls):
        cls.OPTIONS = [
            ...
            Option(
                option_type=make_option_type(EnumOption, enum_type=PathEnum, value_option=PathOption('_')),
                value=PathEnum.A,
    ...
    def test_value_option_is_set_for_known_types(self):
        class MyConfig(StubConfig):
            ...
            path_enum = EnumOption('PathEnum', PathEnum, value_option=PathOption('_'))
            path_enum_no_value_option = EnumOption('PathEnum2', PathEnum)

        self.assertIsInstance(MyConfig.int_enum._value_option, IntOption)
        self.assertIsInstance(MyConfig.float_enum._value_option, FloatOption)
        self.assertIsInstance(MyConfig.str_enum._value_option, StringOption)
